...
class camera {
    ...
    private:
        ...
        void initialize() {
            ...
            auto viewport_upper_left = center - vec3(0, 0, focal_length) - viewport_u/2 - viewport_v/2; // Q
            pixel00_loc = viewport_upper_left + 0.5 * (pixel_delta_u + pixel_delta_v); // P_{0,0}
        }
        ...
        color ray_color(const ray& r, int depth, const hittable& world) const {
            ...
            // Set to 0.001 instead of 0 due to rounding errors causing intersection point to be slightly off
